  ...
  <div className="w-full animate-in fade-in duration-500 text-center">
    <section className="bg-white pt-40 pb-20 border-b border-[#F0EFEA] text-center text-center">
      <div className="max-w-7xl mx-auto px-8 md:px-16 text-center text-center">
        <span className="text-[#D4C4A8] font-black tracking-[0.5em] text-sm uppercase block mb-4 text-center text-center">
          Connect with us
        </span>
        ...
        <p className="mt-8 text-xl text-gray-500 font-bold text-center text-center text-center break-keep">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center text-center">
          {[
            ...
            >
              ...
              <p className="text-gray-400 font-black text-[10px] uppercase tracking-widest mb-1 text-center break-keep">
                {item.label}
              </p>
              <p className="text-[#4A4238] font-black text-lg break-all text-center break-keep">
                {item.value}
              </p>
            </a>
          ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center text-center lg:text-left">
          <div className="space-y-10 text-center lg:text-left">
            <div className="space-y-4 text-center lg:text-left">
              ...
              <h3 className="text-4xl md:text-5xl font-black text-[#4A4238] leading-tight text-center lg:text-left break-keep">
                Shinjuku <br />
                Miraina Tower
              </h3>

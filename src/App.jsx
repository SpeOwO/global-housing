    ...
    <div className="w-full">
      ...
      <section className="bg-white min-h-screen flex items-center py-20 border-b border-[#F0EFEA]">
        <div className="w-full px-6 md:px-12 lg:px-16 grid grid-cols-1 md:grid-cols-2 gap-10">
          {[
            ...
            <div 
              key={i}
              className="relative h-[600px] group overflow-hidden rounded-[3rem] cursor-pointer shadow-2xl transform transition-all duration-700 hover:-translate-y-4" 
      ...
      <section id="rental-process" className="bg-[#FAF9F6] min-h-screen flex items-center py-20 border-b border-[#F0EFEA]">
        <div className="w-full px-4 md:px-10 lg:px-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-x-0 gap-y-12 relative max-w-screen-xl mx-auto">
            {[
      ...
      {/* 4. Sale Service Section - 정보 위주의 강렬한 가시성 */}
        ...
        <div className="w-full px-8 md:px-16 lg:px-24 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
          <div className="space-y-12">
            <div className="space-y-6">
              <span className="text-[#D4C4A8] font-black tracking-[0.5em] text-sm uppercase block text-center lg:text-left">Investment Guide</span>
              <h2 className="text-6xl md:text-8xl font-black text-[#4A4238] uppercase tracking-widest leading-none text-center lg:text-left">Sale<br />Service</h2>
              <div className="w-32 h-2 bg-[#4A4238] rounded-full mx-auto lg:mx-0"></div>
            </div>
            <p className="text-gray-600 leading-[2] text-xl md:text-2xl font-bold max-w-2xl text-center lg:text-left">
              단순한 매매를 넘어, 일본 부동산 시장의 흐름을 분석하고<br />
              <span className="text-[#4A4238]">최적의 자산 가치 창출</span>을 위한 토탈 솔루션을 제안합니다.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-4">
              {[
                { title: "전문가 컨설팅", desc: "15년 경력 투자 매니저 배정", icon: UserCheck },
                { title: "사후 관리 서비스", desc: "임대 관리 및 세무 업무 지원", icon: HeartHandshake }
              ].map((box, i) => (
                <div key={i} className="p-10 bg-[#FAF9F6] rounded-[2.5rem] border border-[#F0EFEA] hover:bg-[#4A4238] group transition-all duration-500 shadow-lg hover:shadow-2xl">
                  <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#D4C4A8] transition-all text-center mx-auto lg:mx-0">
                    <box.icon size={28} className="text-[#4A4238] group-hover:text-white" />
                  </div>
          ...
          <div className="relative text-center">
             <div className="bg-white p-6 rounded-[5rem] shadow-[0_50px_100px_-20px_rgba(74,66,56,0.3)] relative z-10 mx-auto max-w-lg lg:max-w-none border border-[#F0EFEA]">
               <div className="bg-[#4A4238] aspect-square rounded-[4rem] flex flex-col items-center justify-center p-12 space-y-10 text-white shadow-inner">
                 ...
                 <button onClick={() => navigate('contact')} className="w-full bg-[#D4C4A8] text-[#4A4238] py-6 rounded-3xl font-black text-xl uppercase tracking-widest hover:bg-white hover:scale-105 transition-all shadow-2xl">
                   상담 예약하기
                 </button>
               </div>
             </div>
      ...
      <section className="relative min-h-screen flex items-center pt-24 bg-[#4A4238] overflow-hidden">
        ...
        <div className="relative w-full px-8 md:px-16 lg:px-24 z-10 text-center lg:text-left">
          <div className="max-w-5xl space-y-8 mx-auto lg:mx-0">
            ...
            <p className="text-xl md:text-3xl font-bold text-gray-300 max-w-3xl leading-relaxed mx-auto lg:mx-0">
              글로벌 하우징은 국경을 넘어 모든 고객이 일본에서 새로운 삶의 시작을 안심하고 설계할 수 있도록 돕는 신뢰의 가교입니다.
            </p>
          </div>
        </div>
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce hidden md:block text-[#D4C4A8]">
        ...
        <div className="w-full px-8 md:px-16 lg:px-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div className="space-y-10">
              ...
              <p className="text-xl text-gray-500 font-bold leading-relaxed text-center lg:text-left">
                단순한 중개를 넘어 라이프스타일 큐레이터로서 정착의 모든 과정을 함께합니다. 고객의 신뢰를 가장 큰 자산으로 여깁니다.
              </p>
            </div>
      ...
      <section className="bg-white min-h-screen flex flex-col justify-center py-24 relative overflow-hidden">
        <div className="w-full px-8 md:px-16 lg:px-24 mb-16">
          <div className="max-w-4xl space-y-4">
            ...
            <h2 className="text-5xl md:text-7xl font-black text-[#4A4238] leading-tight">Shinjuku <span className="text-[#D4C4A8]">Miraina Tower</span></h2>
            <div className="w-24 h-1.5 bg-[#4A4238] rounded-full"></div>
          </div>
        </div>
            ...
            <div className="bg-[#FAF9F6] p-10 rounded-[3rem] border border-[#F0EFEA] space-y-8 shadow-sm text-left">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600 font-bold leading-relaxed">
                  4 Chome-1-6 Shinjuku, Shinjuku City, Tokyo 160-0022<br />
                  Shinjuku Miraina Tower
                </p>
              </div>
              <button onClick={() => navigate('contact')} className="w-full bg-[#4A4238] text-white py-4 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-[#3d362d] transition-all">
                상담 방문 예약하기
              </button>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-20 items-center">
            <div className="w-full lg:w-1/2 relative">
              <div className="bg-white p-6 rounded-[5rem] shadow-2xl relative z-10 border border-[#F0EFEA]">
                <div className="aspect-[3/4] rounded-[4rem] bg-gray-100 overflow-hidden text-center">
            ...
            <div className="w-full lg:w-1/2 space-y-10 text-center lg:text-left">
              ...
              <div className="space-y-8 text-lg text-gray-600 font-bold leading-relaxed italic">
                <p>"일본에서의 첫 시작은 설렘만큼이나 두려움도 크다는 것을 잘 알고 있습니다. 언어와 문화의 장벽 앞에서 집이라는 가장 기초적인 울타리를 만드는 일에 누구보다 진심으로 임하겠습니다."</p>
                <p>"우리는 단순한 계약 성사를 넘어, 고객이 일본 사회에 안정적으로 정착하고 더 큰 미래를 꿈꿀 수 있는 주거 기반을 제공하는 것에 자부심을 느낍니다."</p>
              </div>
  ...
  const ContactPage = () => (
    <section id="contact" className="bg-[#FAF9F6] min-h-screen flex items-center py-20 pt-32 text-center lg:text-left">
      <div className="w-full px-8 md:px-16 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center">
        ...
        <div className="bg-white p-10 lg:p-12 rounded-[4rem] shadow-2xl border border-[#F0EFEA]">
